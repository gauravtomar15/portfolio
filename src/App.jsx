...
function useActiveSection(sectionIds) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setProgress(
        pageHeight > 0
          ? Math.min(100, Math.round((scrollY / pageHeight) * 100))
          : 0,
      );
  ...
  return (
    <div className="relative overflow-hidden bg-[#0B0F19] text-slate-100">
      ...
      <main className="relative mx-auto max-w-7xl px-6 pb-24 pt-8 sm:px-8 lg:px-10">
        ...
        <section id="about" className="mt-24">
          ...
          <SectionHeading
            number="01"
            title="About Me"
            subtitle="Professional journey, video introduction, and story timeline."
          />
      ...
      <TimelineItem key={entry.year + entry.title} entry={entry} />
        ...
        <section id="skills" className="mt-24">
          <SectionHeading
            number="02"
            title="Skills"
            subtitle="Organized expertise shown in premium skill cards."
          />
        ...
        <section id="projects" className="mt-24">
          <SectionHeading
            ...
            subtitle="High-end product showcases with dynamic filters."
          />
        ...
        <section id="philosophy" className="mt-24">
          <SectionHeading
            ...
            subtitle="How I approach design, engineering, and production quality."
          />
        ...
        <section id="highlights" className="mt-24">
          <SectionHeading
            ...
            subtitle="Core strengths that reflect my growth as a full stack developer and problem solver."
          />
          <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
            {highlights.map((item) => (
              <motion.div
                whileHover={{ y: -6 }}
                className="glass-card rounded-3xl border border-white/10 p-6 shadow-glow transition"
              >
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  {socialLinks.map((item) => (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-3 text-sm text-slate-100 transition hover:border-cyan-300/30 hover:bg-cyan-400/10"
                    >
      ...
      <footer className="border-t border-white/10 bg-[#090E19]/90 py-8 text-center text-sm text-slate-500">
        <p>
          Designed with premium motion, glassmorphism, and professional
          engineering craftsmanship.
        </p>
        <p className="mt-3 text-slate-400">
          © 2026 Gaurav Tomar. Built with React, Tailwind, and Framer Motion.
        </p>
      </footer>
