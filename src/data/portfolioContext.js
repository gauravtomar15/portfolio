...
export const portfolioContext = {
  ...
  about: {
    shortBio:
      "Full-Stack Developer specializing in React.js, Node.js, TypeScript, and MongoDB, with experience building scalable web applications and real-time systems.",

    longBio:
      "Passionate Full-Stack Developer focused on building scalable, high-performance web applications. Experienced in modern frontend and backend technologies, RESTful APIs, real-time communication, and cloud deployment. Strong foundation in Data Structures, Algorithms, System Design, and software engineering best practices.",
    education: {
  ...
  projects: [
    ...
    },
    {
      ...
      category: "Frontend",
      description:
        "eature-rich movie streaming UI with AI-powered search and optimized frontend performance.",
  ...
  experience: [
    {
      ...
      description:
        "Developed and maintained full-stack features for the company's main SaaS platform.",
      achievements: [
  ...
  achievements: [
    {
      ...
      description:
        "Expert in Data Structures and Algorithms with strong problem-solving skills",
...
6. For contact: provide email and phone number: gauravtomar977@gmail.com, +91 -9639508340
...
export const quickActions = [
  {
    ...
    prompt:
      "Can you tell me about the projects you've built and what technologies you used?",
  },
  {
