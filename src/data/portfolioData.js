  ...
  skills: [
    {
      category: 'Frontend',
      icon: FaReact,
      items: ['React.js', 'Next.js', 'TypeScript', 'JavaScript (ES6+)', 'HTML5', 'CSS3', 'Tailwind CSS', 'Sass', 'Redux Toolkit', 'Context API']
    },
    {
      category: 'Backend',
      icon: SiExpress,
      items: ['Node.js', 'Express.js', 'REST API', 'JWT Auth', 'Socket.io', 'WebSockets']
    },
    {
      category: 'Database',
      icon: FaDatabase,
...
philosophy: [
  {
    icon: FaLaptopCode,
    title: 'Clean Code',
    description: 'Writing scalable and maintainable code with reusable components and structured architecture.'
  },
  {
    icon: FaShieldAlt,
    title: 'Problem Solving',
    description: 'Applying strong DSA and logical thinking to build efficient and reliable solutions.'
  },
  {
    icon: FaRocket,
    title: 'Performance Focus',
    description: 'Optimizing applications for faster load times, smooth interactions, and better user experience.'
  },
  {
    icon: FaMobileAlt,
    title: 'Responsive Design',
    description: 'Creating modern interfaces that work seamlessly across mobile, tablet, and desktop devices.'
  }
],
 highlights: [
  { title: 'Frontend Development', detail: 'Building scalable and responsive interfaces using React.js, TypeScript, and Tailwind CSS.' },
  { title: 'Backend Development', detail: 'Developing secure and efficient server-side applications with Node.js and Express.js.' },
  { title: 'DSA & Problem Solving', detail: 'Practicing data structures and algorithms to strengthen logical and optimized thinking.' },
  { title: 'API Integration', detail: 'Integrating REST APIs and handling real-time communication for dynamic applications.' },
  { title: 'Authentication', detail: 'Implementing JWT-based authentication and secure user session management.' },
  { title: 'State Management', detail: 'Managing scalable application state using Redux Toolkit and modern React patterns.' },
  { title: 'Database Management', detail: 'Working with MongoDB and MySQL for efficient data handling and storage.' },
  { title: 'Performance Optimization', detail: 'Optimizing UI rendering, load speed, and overall application performance.' }
],
  contact: {
    summary: 'I’m open to software development roles and collaborations. Let’s build scalable and impactful products together.',
    email: 'gauravtomar977@gmail.com',
    phone: '+91 9639508340',
    location: 'Delhi, India',
  },
  socialLinks: [
    { icon: FaGithub, label: 'GitHub', href: 'https://github.com/gauravtomar15' },
    { icon: FaLinkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/in/gaurav-tomar-b19a86258/' },
