    ...
    <section id="home" className="relative overflow-hidden pt-10 lg:pt-14">
      <div className="relative mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-8 xl:px-10">
        <div className="space-y-8">
          ...
          >
            <span className="inline-flex rounded-full border border-cyan-400/20 bg-cyan-400/10 px-4 py-2 text-sm font-medium uppercase tracking-[0.35em] text-cyan-200">
              {hero.badge}
            </span>
            ...
            <p className="mt-3 h-6 min-h-[1.5rem] whitespace-nowrap overflow-hidden text-sm uppercase tracking-[0.35em] text-cyan-300/80">
              {typedRole}
            </p>
          </motion.div>
